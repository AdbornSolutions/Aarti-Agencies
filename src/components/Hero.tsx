  ...
  return (
    <section
      ...
      <motion.div
        ...
        <motion.div
          ...
          <div className="flex flex-wrap items-center gap-3">
            <MagneticButton variant="solid" tone="light">
              Explore Collections
            </MagneticButton>
            <MagneticButton variant="outline" tone="light">
      ...
      <motion.div
        ...
        <span className="font-sans text-[9px] uppercase tracking-[0.3em] text-ivory/45">Scroll</span>
