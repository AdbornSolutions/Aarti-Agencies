...
function Footer() {
  ...
  return (
    <footer className="relative w-full overflow-hidden bg-night pt-24 text-ivory">
      <div className="mx-auto max-w-[1600px] px-6 md:px-10">
        <div className="grid grid-cols-1 gap-14 lg:grid-cols-12 lg:gap-10">
          <div className="lg:col-span-4">
            <p className="font-display text-4xl leading-none">Arti Agencies</p>
            <p className="mt-4 max-w-xs font-sans text-sm font-light leading-relaxed text-ivory/50">
              Wholesale laminates and surface solutions for Nagpur and the Vidarbha region.
            </p>
          </div>
          <nav className="lg:col-span-3" aria-label="Footer">
            <p className="font-sans text-[10px] uppercase tracking-[0.28em] text-ivory/35">
              Navigate
            </p>
          ...
          <div className="lg:col-span-2">
            ...
            <address className="mt-6 space-y-3 font-sans text-sm font-light not-italic text-ivory/70">
              <p>
                <a href="tel:+918983455122">+91 89834 55122</a>
              </p>
              <p>
          ...
          <div className="lg:col-span-3">
            ...
            <p className="mt-3 font-sans text-xs font-light leading-relaxed text-ivory/45">
            ...
            <form onSubmit={submit} className="mt-6" noValidate>
              ...
              <div className="flex items-center gap-3 border-b border-ivory/25 pb-3 transition-colors duration-300 ease-editorial focus-within:border-rust">
                <input
                  id="newsletter-email"
                  type="email"
                  value={email}
        ...
        <DrawLine className="mt-20 h-px w-full bg-ivory/15" />
        <div className="flex flex-col gap-3 py-8 font-sans text-[10px] uppercase tracking-[0.2em] text-ivory/35 md:flex-row md:items-center md:justify-between">
          <p>© {/* @__PURE__ */ new Date().getFullYear()} Arti Agencies. All rights reserved.</p>
          <p>Privacy · Terms · Dealer Enquiries</p>
        </div>
      </div>
      <motion.p
        aria-hidden="true"
