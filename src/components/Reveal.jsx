...
function WordReveal({ text, className, delay = 0, stagger = 0.08, id, as = 'h2' }) {
  const Tag = motion[as];
...
function CurtainImage({ src, alt, className = '', imageClassName = '', delay = 0 }) {
  return (
    <motion.div
...
export { CurtainImage, DrawLine, EASE, FadeUp, WordReveal };
