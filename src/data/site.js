...
const strengths = [
  {
    ...
    description: "Every sheet is pressed, tested and graded to hold its colour, edge and finish for decades of daily use."
  },
  {
    index: "02",
    title: "Extensive Collection",
    description: "Over five thousand d\xE9cors across woodgrain, stone, solid and textured families \u2014 specified from one place."
  },
  {
    index: "03",
    title: "Trusted Expertise",
    description: "Two decades of supplying architects, contractors and furniture manufacturers across the region."
  },
  {
    index: "04",
    title: "Modern Designs",
    description: "Seasonal d\xE9cor releases developed alongside interior designers to stay ahead of specification trends."
  },
  {
    index: "05",
    title: "Reliable Service",
    description: "Held stock, sampling support and scheduled site delivery that keeps installation programmes on time."
  }
];
...
const stats = [
  ...
  { value: 5e3, suffix: "+", label: "D\xE9cors in the catalogue" },
  { value: 1e3, suffix: "+", label: "Clients served" },
